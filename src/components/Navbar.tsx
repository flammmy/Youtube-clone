    ...
    return (
        <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
            <div className="flex gap-8 items-center text-2xl">
                ...
                <Link to="/">
                    <div className="flex gap-1 items-center justify-center">
                        ...
                        <span className='text-xl font-medium'>Youtube <sup className='text-[.7rem]'>TM</sup></span>
                    </div>
                </Link>
            </div>
            ...
            <div className="flex gap-5 items-center text-xl">
                ...
                <img className="w-9 h-9 rounded-full object-cover" src="https://dynaimage.cdn.cnn.com/cnn/c_fill,g_auto,w_1200,h_675,ar_16:9/https%3A%2F%2Fcdn.cnn.com%2Fcnnnext%2Fdam%2Fassets%2F211227135008-02-the-batman-trailer.jpg" alt="" />
            </div>
        </div>
    )
}
